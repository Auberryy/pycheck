...
def print_json_report(entries: List[Dict[str, Any]], exit_code: int) -> None:
    ...
    print(json.dumps(sanitize_value(payload), indent=2))
...
def main(argv: List[str] | None = None) -> int:
    ...
    entries.append(sanitize_value(capability_entry))
    ...
    entries.append(sanitize_value(ssl_entry))
    ...
    if args.json:
        ...
        _print_capability(sanitize_value(capability))
        _print_capability(sanitize_value(ssl_capability))
